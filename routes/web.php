...
Route::get('/register/consultant', 'consultantController@index');
Route::post('/add/register/consultant', 'consultantController@store');
...
Route::get('/show/consultant', 'userController\clientController@index')->name('company');

Route::get('/show/consultant/date/{name}', 'userController\clientController@date')->name('company');
